"""
Django settings for recrutation project.
...
ALLOWED_HOSTS = ['recrutation-lukasz-v1.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'recrutation.wsgi.application'
